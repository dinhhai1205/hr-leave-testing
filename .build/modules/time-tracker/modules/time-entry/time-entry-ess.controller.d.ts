...
import { CreateTimeEntryBodyDto, DeleteTimeEntryDto, GetDetailTimeEntryQueryDto, GetTimeEntriesCountDto, GetTimeEntriesOverviewQueryESSDto, GetTimeSheetQuery, TimeEntryResponseDTO, UpdateMultiTimeEntryDto } from './dtos';
import { TimeSheetService } from './services';
import { TimeEntryService } from './services/time-entry.service';
import { TimeEntryEntity } from './time-entry.entity';
export declare class TimeEntryESSController {
    private timeEntryService;
    private timeSheetService;
    constructor(timeEntryService: TimeEntryService, timeSheetService: TimeSheetService);
    create(employeeId: number, createTimeEntryDto: Omit<CreateTimeEntryBodyDto, 'employeeId'>, { companyId }: BaseParamDto, { timeTrackerCompanyId }: TimeTrackerMapping): Promise<TimeEntryResponseDTO | TimeEntryResponseDTO[]>;
    ...
    getTimeEntriesEmployeeOverview(employeeId: number, { companyId }: BaseParamDto, { timeTrackerCompanyId }: TimeTrackerMapping, query: GetTimeEntriesOverviewQueryESSDto): Promise<{
        page: number;
        take: number;
        itemCount: number;
        pageCount: number;
        ...
        hasNextPage: true;
        data: import("../../common/interfaces").ITimeEntryOverviewResponse[];
    }>;
    getTimeEntriesOverviewSummarize(employeeId: number, { companyId }: BaseParamDto, { timeTrackerCompanyId }: TimeTrackerMapping, query: GetTimeEntriesOverviewQueryESSDto): Promise<any>;
    getTimeEntriesOverview(employeeId: number, { companyId }: BaseParamDto, { timeTrackerCompanyId }: TimeTrackerMapping, query: GetTimeEntriesOverviewQueryESSDto): Promise<{
    ...
    getTimeSheetDetail(employeeId: number, { companyId }: BaseParamDto, query: GetTimeSheetQuery, { timeTrackerCompanyId }: TimeTrackerMapping): Promise<{
        data: any;
    }>;
    getTimeSheetOverview(employeeId: number, query: GetTimeEntriesOverviewQueryESSDto, { companyId }: BaseParamDto, { timeTrackerCompanyId }: TimeTrackerMapping): Promise<any>;
